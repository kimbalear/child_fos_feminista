...
$templatecontext = [
    ...
    'imagegirlpower' => $OUTPUT->image_url('ou_img/logo', 'theme_ktt_boost_child_cmrn'),
    'imagecameroon' => $OUTPUT->image_url('ou_img/logo', 'theme_ktt_boost_child_cmrn'),
    'imagegmaveric' => $OUTPUT->image_url('ou_img/logo', 'theme_ktt_boost_child_cmrn'),
    'imagepsi' => $OUTPUT->image_url('ou_img/psi-cameroon', 'theme_ktt_boost_child_cmrn'),
