...
function theme_child_fos_feminista_get_main_scss_content($theme) {
    global $CFG;
    ...
    } else if ($filename && ($presetfile = $fs->get_file($context->id, 'theme_child_fos_feminista', 'preset', 0, '/', $filename))) {
        // This preset file was fetched from the file area for theme_child_fos_feminista and not theme_boost (see the line above).
